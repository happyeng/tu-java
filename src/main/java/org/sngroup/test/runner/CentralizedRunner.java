...
//
//public class CentralizedRunner extends Runner {
//    private static final int THREAD_POOL_READ_SIZE = 5; // 设置线程池大小
//    public ThreadPool threadPool;
//    // private final Serialization srl;
//    Map<String, Device> devices;
//
//    Map<String, BufferedWriter> saveBW;
//    public CentralizedRunner(){
//        super();
//
...
//        System.out.println("Start initializeDevice in Runner!!!!!");
//        initializeDevice();
////        initializeDevice_pall();
//
